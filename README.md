...
| [pr](skills/pr/) | Create a pull request for the current branch; gates on this session's /review-branch report for plan branches and on BUG.md's verdict for bug branches |
...
| [review-branch](skills/review-branch/) | Full-branch review vs base: runtime-integrity-reviewer + precedent-reviewer in parallel, joined by docs-accuracy-reviewer when the diff ships user-facing text; reports in chat |
...
| [core-skills](plugins/core-skills/) | [catchup](plugins/core-skills/skills/catchup/), [worktree](plugins/core-skills/skills/worktree/), [build-it](plugins/core-skills/skills/build-it/), [commit](plugins/core-skills/skills/commit/), [fix-bug](plugins/core-skills/skills/fix-bug/), [grill-me](plugins/core-skills/skills/grill-me/), [implement-plan](plugins/core-skills/skills/implement-plan/), [memory-hygiene](plugins/core-skills/skills/memory-hygiene/), [newbranch](plugins/core-skills/skills/newbranch/), [next](plugins/core-skills/skills/next/), [plan-feature](plugins/core-skills/skills/plan-feature/), [pr](plugins/core-skills/skills/pr/), [research](plugins/core-skills/skills/research/), [retro](plugins/core-skills/skills/retro/), [review-branch](plugins/core-skills/skills/review-branch/), [review-mcp-descriptions](plugins/core-skills/skills/review-mcp-descriptions/), [shepard](plugins/core-skills/skills/shepard/), [sync-worktrees](plugins/core-skills/skills/sync-worktrees/), [task-writer](plugins/core-skills/skills/task-writer/), [wireframe](plugins/core-skills/skills/wireframe/) | Project-agnostic catalog skills bundled into one plugin; reads `.claude/project-context.md` for project-specific facts |
...
| [docs-accuracy-reviewer](agents/docs-accuracy-reviewer.md) | Grade every claim in the user-facing text one branch ships against the code that branch ships; review-time, path-triggered on `{{DOC_PATHS}}` |
| [docs-auditor](agents/docs-auditor.md) | Audit CLAUDE.md and docs against codebase for drift, on demand and repo-wide |
...
| [surface-reviewer](agents/surface-reviewer.md) | Audit a plan's Security & Cost Surface section against seven question-shaped rows; plan-time, runs beside plan-reviewer |
