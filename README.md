...
| [kendo-pm](plugins/kendo-pm/) | [kendo-mcp](plugins/kendo-pm/skills/kendo-mcp/) | Kendo project-management skills bundled into one plugin, for any project using Kendo for issue tracking |
