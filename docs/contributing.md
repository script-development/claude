...
1. Copy the template:
   ```bash
   cp -r templates/skill-template plugins/core/skills/your-skill-name
   ```

2. Edit `plugins/core/skills/your-skill-name/SKILL.md`:
...
1. Copy the template:
   ```bash
   cp templates/agent-template.md plugins/core/agents/your-agent-name.md
   ```

2. Edit `plugins/core/agents/your-agent-name.md`:
