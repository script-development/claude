...
1. `<plan_feature_skill_dir>/references/surface-questions.md` — **the canonical seven row
...
2. `<plan_feature_skill_dir>/references/quality-gates.md` § Phase 1.6 — sycophancy guards.
