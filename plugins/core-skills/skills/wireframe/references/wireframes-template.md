...
Save the spec to `WIREFRAMES.md` in the plan directory (see `wireframe`'s Step 1 for how that's
derived) — e.g. `docs/plans/KD-0072-short-description/WIREFRAMES.md`. The document
...
```markdown
# KD-0072: Wireframe Specifications
