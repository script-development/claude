...
- **Build now** → invoke this plugin's **`build-it`** skill. It cuts the worktree, writes the
  chosen docs into it so they ride the new branch, implements the alignment, and ships the PR.
